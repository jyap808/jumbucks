...
"for example: alertnotify=echo %%s | mail -s \"Jumbucks Alert\" admin@foo."
"com\n"),
...
"If the file does not exist, create it with owner-readable-only file "
"permissions."),
QT_TRANSLATE_NOOP("bitcoin-core", "Jumbucks version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Cannot obtain a lock on data directory %s.  Jumbucks is probably already "
"running."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart Jumbucks to complete"),
...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Unable to bind to %s on this computer. Jumbucks is probably already running."),
...
"your clock is wrong Jumbucks will not work properly."),

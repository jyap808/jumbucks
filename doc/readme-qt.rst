...
To use UPnP for port forwarding behind a NAT router (recommended, as more connections overall allow for a faster and more stable jumbucks experience), pass the following argument to qmake:
